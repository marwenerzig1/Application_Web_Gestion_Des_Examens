...
<form name="myForm" action="{{route('comptes.update', $compte->id )}}" method="POST" enctype="multipart/form-data" >
    @csrf
    @method('PATCH')
    ...
    <h1 class="h3 mb-3 fw-normal" style="color: rgb(8, 24, 49)">Modifier Compte Etudiant</h1> <br>
      ...
      @endif <br> 
      <label id="tt2">Role : </label>
      <!-- <input type="text" name="role" class="form-control" value="{{$compte->role}}" id="floatingInput" > -->
      <select name="role" class="form-control" >
        <option value="{{$compte->role}}">{{$compte->role}}</option>
...
<a class="w-100 btn btn-lg btn-primary" href="/comptesensignant" id="btn2">Annuler</a>
</main>
  </body>
</html>