...
<article>
    <div>
    <h1 class="liste">Liste des comptes des etudiantes : </h1>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-dark btn-sm" href="modifier_compteetudiant/{{ $compte->id }}">
                      <i class="fa fa-edit"></i> Modifier
                      </a>
                    <a class="btn btn-danger btn-sm" href="/click_deletecompte/{{$compte->id}}" >
