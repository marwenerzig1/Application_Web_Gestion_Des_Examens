...
<form name="myForm" action="{{route('classes.update', $classe->id )}}" method="POST" enctype="multipart/form-data" >
    @csrf
    @method('PATCH')
    ...
    <h1 class="h3 mb-3 fw-normal" style="color: rgb(8, 24, 49)">Modifier Classe</h1> <br>
      ...
      <input type="text" name="nom" class="form-control" value="{{$classe->nom_Classe}}" id="floatingInput" > <br> 
      @if ($errors->has('nom'))
