...
<nav>
    <div class="sidenav">
        ...
        <img src="{{ asset('images/tu1.png') }}" alt="tag" width="200px" height="160px">
           <h2>Application Gestion d'examen <br>Page de connexion</h2>
           <p>Connectez-vous ou inscrivez-vous à partir d'ici pour accéder.</p> 
        </div>
     </div>
     <div class="container">
        <div class="row">
     ...
     <div class="main">
        <div class="col-md-6 col-sm-12">
           <div class="login-form">
            ...
            <form name="myForm"  action="{{route('connexion.store2')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                ...
                <center> <button type="submit" class="btn btn-black" style="font-size: 20px" >Connexion</button> </center> <br> 
                 <a href="/inscrire_enseignant" class="btn btn-secondary" style="font-size: 15px">S'inscrire comme enseignant</a><br>
                 <a href="/inscrire_etudiant"  id="btnn" class="btn btn-secondary" style="font-size: 15px" >S'inscrire comme étudiant</a>
              </form>
           </div>
        </div>
     </div>
