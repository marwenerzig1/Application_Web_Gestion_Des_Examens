...
<nav>
    <div class="sidenav">
        ...
        <img src="{{ asset('images/tu1.png') }}" alt="tag" width="200px" height="160px">
           ...
           <p>Formulaire d'inscription enseignant .</p> 
     ...
     <div class="main">
        <div class="row py-5 mt-4 align-items-center">
            ...
            <div class="col-md-7 col-lg-6 ml-auto">
                <form name="myForm"  action="{{route('enseignants.store')}}" method="POST" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
    
                        <div class="title">
                            <h3 style="font-family: cursive">Formulaire d'inscription enseignant</h3>
                            <br>
                        </div>
                        <!-- First Name -->
